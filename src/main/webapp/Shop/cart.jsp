...
<body>
    ...
    <div class="content-section">
        <div class="container">
            <div class="row">
			<c:forEach var="prod" items="${sessionScope['cart'].cart}">				
                <div class="col-md-4 col-md-push-2">
                    <div class="cart-image">
                        <img src="Shop/images/products/${prod.key.id}.jpg" alt="">
                    </div> <!-- /.product-image -->
				</div>	
				<div class="col-md-8">	
                    <div class="product-information">
						<br/>
                        <h2>${prod.key.name } ( x ${prod.value})</h2>
                        <p class="product-infos">
                            <span>Price per piece: ${prod.key.price} UAH</span>
                        </p>
                        <ul class="product-buttons">
                            <li>
								<img src="Shop/images/products/plus.png" onclick="plus(${prod.key.id})"  width=20 height=20>
								<input type="text" name="amount" value="${prod.value}" id="amount${prod.key.id}" style="height:40px; width:50px"/>
								<img src="Shop/images/products/minus.png" onclick="minus(${prod.key.id})"  width=20 height=20>
								<input type="submit" class="s-button" onclick="ajax(${prod.key.id})" id="but" value="Delete">
                            </li>
						</ul>
						<hr/>
						<p class="product-infos-cart">
							<span>Price: ${prod.key.price * prod.value} UAH</span>
							<c:set var="total" value="${total + ( prod.key.price * prod.value )}" />
						</p>
			...
			<p class="product-infos-cart">
				<span>TOTAL PRICE: ${total} UAH</span>
			</p>
			<hr align="center" width="350" color="red" />
            </div> <!-- /.row -->
        </div> <!-- /.container -->
    </div> <!-- /.content-section -->
